...
export const COMPONENT_DEFS = {
  ...
  relay: {
    ...
    hasCoil: { positive: 'A1', negative: 'A2' },
    terminals: [
      { id: 'A1', x: -55, y: -65, label: 'A1' },
      { id: 'A2', x: 55, y: -65, label: 'A2' },
      { id: 'NO_A', x: -45, y: 60, label: '13' },
      { id: 'NO_B', x: -15, y: 60, label: '14' },
      { id: 'NC_A', x: 15, y: 60, label: '21' },
      { id: 'NC_B', x: 45, y: 60, label: '22' },
    ],
    internalLinks: (s) => {
      const e = !!s.energized;
      return e ? [['NO_A', 'NO_B']] : [['NC_A', 'NC_B']];
  ...
  lamp_green: {
    ...
    lampColor: '#10B981',
    terminals: [
      { id: 'A', x: -25, y: 38, label: 'X1' },
      { id: 'B', x: 25, y: 38, label: 'X2' },
    ],
    internalLinks: () => [],
  },
  lamp_yellow: {
  ...
  push_button_start: {
    ...
    terminals: [
      { id: 'T1', x: -40, y: 22, label: '3' },
      { id: 'T2', x: 40, y: 22, label: '4' },
    ],
    internalLinks: (s) => (s.pressed ? [['T1', 'T2']] : []),
  },
  push_button_stop: {
    type: 'push_button_stop',
    name: 'زر إيقاف (NC)',
    icon: 'PowerOff',
    width: 110,
    height: 80,
    ...
    defaultState: { pressed: false },
    terminals: [
      { id: 'T1', x: -40, y: 22, label: '1' },
      { id: 'T2', x: 40, y: 22, label: '2' },
    ],
    internalLinks: (s) => (s.pressed ? [] : [['T1', 'T2']]),
  },
  emergency_stop: {
    ...
    defaultState: { pressed: false },
    terminals: [
      { id: 'T1', x: -40, y: 38, label: '1' },
      { id: 'T2', x: 40, y: 38, label: '2' },
    ],
    internalLinks: (s) => (s.pressed ? [] : [['T1', 'T2']]),
  },
  fuse: {
    ...
    height: 60,
    max: 3,
    defaultState: { blown: false },
    terminals: [
      { id: 'T1', x: -45, y: 0, label: '1' },
      { id: 'T2', x: 45, y: 0, label: '2' },
    ],
    internalLinks: (s) => (s.blown ? [] : [['T1', 'T2']]),
  },
  breaker: {
    type: 'breaker',
    name: 'قاطع كهربائي',
    ...
    terminals: [
      { id: 'T1', x: -45, y: 22, label: '1' },
      { id: 'T2', x: 45, y: 22, label: '2' },
    ],
    internalLinks: (s) => (s.closed ? [['T1', 'T2']] : []),
  },
};
